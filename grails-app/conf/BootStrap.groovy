...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		SecUser zumosuser1 = new SecUser(username:"zumosuser1", password:"asdf#1234", enabled: true, accountExpired: false, accountLocked: false, passwordExpired: false)
		SecUser zumosuser2 = new SecUser(username:"zumosuser2", password:"asdf#1234", enabled: true, accountExpired: false, accountLocked: false, passwordExpired: false)
