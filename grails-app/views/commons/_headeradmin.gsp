    ...
    <div class="container-fluid">
      ...
      <div class="nav-collapse">
        <ul class="nav">
			...
			<li class="${pageProperty(name:'page.recipes')}"><a href="/moderateRecipes">Moderar Recetas</a></li>
     		<li class="${pageProperty(name:'page.ingredients')}"><a href="/moderateIngredients">Moderar Ingredientes</a></li>
        </ul>
      </div><!--/.nav-collapse -->
    </div>
  </div>
