        ...
        <div class="span12">
            ...
            <div class="tabbable tabs-left">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#q2" data-toggle="tab">¿Cómo es la búsqueda inteligente de Recetas?</a>
                    </li>
                    <li>
                        <a href="#q3" data-toggle="tab">Yo tengo una receta buenísima, ¿La puedo compartir?</a>
                    </li>
                    <li>
                        <a href="#q4" data-toggle="tab">Si todos los usuarios pueden subir nuevas recetas y alimentos, <br>¿No habrá mucho información inútil o inadecuada?</a>
                    </li>
                    <li>
                        <a href="#q5" data-toggle="tab">Si tengo alguna duda más, ¿Me puedo comunicar a algún lado?</a>
                    </li>
            ...
            las recetas que los contienen. De esta manera, podés encontrar alternativas para hacer algo rico de comer
            sin salir de tu casa!</p>
                    </div>
