...
class RegisterController extends AbstractS2UiController {
	...
	def forgotPassword = {
		...
		mailService.sendMail {
			...
			subject "HoyQueComemos - Reestablecer contraseña"
			html view: "/email/forgotPassword", model:[user:user, url: url]
		}
	...
	def resetPassword = { ResetPasswordCommand command ->
		...
		flash.message = "Su contraseña se ha cambiado con éxito"
